...
// NEW  GAME,OPTIONS", EXIT",HALL OF FAME
...
public static class UiFunctions
{
    ...
    private static string Mark(string wordtomark)
    {
        ...
        string markedword = start_line + wordtomark + end_line;
    ...
    public static string ColorSelection(int LineMarked)
    {
        ...
        {
            char c = LineArray[i];
            if (c == ' ' && LineArray[i - 1] != ' ' && LineArray[i + 1] != ' ')
            {
                word_toreplace += " ";
            }
            if (c != ' ' && c != '|')
        ...
        string newtext = Menu_Copy.Replace(word_with_spaces, Mark(word_toreplace));
    ...
    // DODANA FUNKCJA: Odświeża główną ramkę po zmianie języka w ustawieniach
    public static void RefreshFrame()
    {
        copy = Menu.MenuCoreArt;
    }

    public static void ClearPrint(int line, string text) // od 25 puste miejsce
    {
    ...
    public static string PlaceForWriting(string what_will_be_writed, int which_line, int max_length, bool only_numbers)
    {
        ...
        Console.Clear();
        UiFunctions.ClearPrint(which_line, front + place_for_typing);
    ...
    public static string RandomComunicates(int number_to_guess, int number_writed)
    {
        ...
        if (Settings.english_mode)
        {
            if (number_to_guess > number_writed)
            {
                ...
                {
                    case 1:
                        return "Too low! Try entering a larger number.";
                    case 2:
                        return "You're aiming too low. Go higher!";
                    case 3:
                        return "My number is bigger. Keep trying!";
                    case 4:
                        return "You're on the right track, but you need to aim higher.";
                    case 5:
                        return "Value is too small! Search in a higher range.";
                    default:
                        return "Too low! Try entering a larger number.";
                }
            }
            else
            {
                ...
                {
                    case 1:
                        return "Too high! Try entering a smaller number.";
                    case 2:
                        return "You overshot! My number is smaller.";
                    case 3:
                        return "You're aiming too high. Come down a bit!";
                    case 4:
                        return "Oops, the value is too high! Try something smaller.";
                    case 5:
                        return "Almost there! But you need to aim a little lower.";
                    default:
                        return "Too high! Try entering a smaller number.";
                }
            }
        ...
        else
        {
            if (number_to_guess > number_writed)
            {
                switch (generated_number)
                {
                    ...
                    case 2:
                        return "Celujesz zbyt nisko. Podnieś trochę stawkę!";
                    case 3:
                        return "Moja liczba jest większa. Próbuj dalej!";
                    case 4:
                        return "Jesteś na dobrym tropie, ale musisz celować wyżej.";
                    case 5:
                        return "Zbyt mała wartość! Szukaj w wyższych przedziałach.";
                    default:
                        return "Za mało! Spróbuj wpisać większą liczbę.";
                }
            }
            else
            {
                switch (generated_number)
                {
                    ...
                    case 2:
                        return "Przestrzeliłeś! Moja liczba jest mniejsza.";
                    case 3:
                        return "Celujesz zbyt wysoko. Zejdź trochę w dół!";
                    case 4:
                        return "Ups, za wysoka wartość! Spróbuj czegoś mniejszego.";
                    case 5:
                        return "Prawie, prawie! Ale musisz celować odrobinę niżej.";
                    default:
                        return "Za dużo! Spróbuj wpisać mniejszą liczbę.";
                }
            }
